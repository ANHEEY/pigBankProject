        ...
        <Container >
                ...
                <table align="center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colSpan={3}>
                                <Form.Control
                                    ...
                                    aria-describedby="basic-addon1"
                                    onChange={(e) => {
                                        setSelectedMyAccount(parseInt(e.target.value))
                                        myAccountChange(e)
                                    }}
                                />
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <button className="btnbtn smaller" onClick={plus10000}>+10000</button>&nbsp;
                                <button className="btnbtn smaller" onClick={plus100000}>+100,000</button>&nbsp;
                                <button className="btnbtn smaller" onClick={plus1000000}>+1,000,000</button>&nbsp;
                                <button className="btnbtnclose smaller" onClick={reset}>초기화</button>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <div className="mb-2" align='center'>
                <a href="/customer/transfer/auto_trans">
                    <button className="btnbtnfind big trns">조회</button>
                </a>{'  '}&nbsp;
