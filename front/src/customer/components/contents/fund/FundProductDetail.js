            ...
            <div className="fundChart">
                ...
                <Chart
                    ...
                    options={{
                        ...
                        hAxis: { title: "기준일자", }, colors: ["#8884d8", "#82ca9d", "#ff0000"],
                    }}
                />
                ...
                <table className="fund-info">
                    <tr>
                        <th>종가</th>
                        <td>
                            {loCale(fundItems.clpr)}
                        </td>
                    </tr>
                    <tr>
                        <th>전일대비</th>
                        <td>
                            {Number(fundItems.vs) > 0 ? (
                                <span className="plusPre">▲{abs(fundItems.vs)}</span>
                            ) : (
                    ...
                    <tr>
                        <th>거래대금</th>
                        <td>
                            {loCale(fundItems.trPrc)}
                        </td>
                    </tr>
                    <tr>
                        <th>순자산총액</th>
                        <td>
                            {loCale(fundItems.nPptTotAmt)}
                        </td>
                    </tr>
                </table>
            </div>
