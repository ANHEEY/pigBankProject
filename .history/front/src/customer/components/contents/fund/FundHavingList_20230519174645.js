...
export default function FundHavingList() { 
    ...
    const sellEtfFund = (isinCd) => { 
        ...
        const sellCount = count.find((count, index) => having[index].fisinCd === isinCd);
    ...
    const handleSellCountChange = (index, value) => {
        const updatedSellCounts = [...count];
        updatedSellCounts[index] = value;
        setCount(updatedSellCounts);
    };
                                        ...
                                        <tr key={having.fisinCd}> 
                                            ...
                                            <td> 
                                                <div id="sellCount"> 
                                                    <input type="number" 
                                                    value={count[index] || 0} 
                                                    onChange={(e) => handleSellCountChange(index, parseInt(e.target.value))} 
                                                        max={having.fhavingCnt} min={0} className="inputNum" /> 
                                                </div> 
                                            </td> 
                                            <td> 
                                                <div id="sellCount"> 
